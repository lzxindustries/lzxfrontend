      ...
      archiveAssets: [
        {
          id: 'archive-1',
          name: 'Demo Schematic',
          fileName: 'demo-schematic_RevA.pdf',
          fileType: 'PDF',
          description: 'Hardware schematic',
          href: 'https://example.com/demo-schematic_RevA.pdf',
          sourcePath: 'downloads/demo-schematic_RevA.pdf',
          relativePath: 'downloads/demo-schematic_RevA.pdf',
          category: 'downloads',
