...
On the right of the module are **Disable** inputs, labeled $\mathrm{\overline{AEN}}$ and $\mathrm{\overline{BEN}}$. The bar over the letters is called a _macron_, and in this context it indicates logical negation. The input label means "not enable", or disable.
